...
bool ScenefileReader::parseLightData(const QJsonObject &lightData, SceneNode *node) {
    ...
    light->color[0] = colorArray[0].toDouble();
    light->color[1] = colorArray[1].toDouble();
    light->color[2] = colorArray[2].toDouble();
    ...
    if (lightType == "directional") {
        ...
        light->dir[0] = directionArray[0].toDouble();
        light->dir[1] = directionArray[1].toDouble();
        light->dir[2] = directionArray[2].toDouble();
    }
        ...
        light->function[0] = attenuationArray[0].toDouble();
        light->function[1] = attenuationArray[1].toDouble();
        light->function[2] = attenuationArray[2].toDouble();
    }
...
bool ScenefileReader::parseCameraData(const QJsonObject &cameradata) {
    ...
    if (cameradata["position"].isArray()) {
        ...
        m_cameraData.pos[0] = position[0].toDouble();
        m_cameraData.pos[1] = position[1].toDouble();
        m_cameraData.pos[2] = position[2].toDouble();
    ...
    if (cameradata["up"].isArray()) {
        ...
        m_cameraData.up[0] = up[0].toDouble();
        m_cameraData.up[1] = up[1].toDouble();
        m_cameraData.up[2] = up[2].toDouble();
    ...
    if (cameradata.contains("look")) {
        if (cameradata["look"].isArray()) {
            ...
            m_cameraData.look[0] = look[0].toDouble();
            m_cameraData.look[1] = look[1].toDouble();
            m_cameraData.look[2] = look[2].toDouble();
        ...
        if (cameradata["focus"].isArray()) {
            ...
            m_cameraData.look[0] = focus[0].toDouble();
            m_cameraData.look[1] = focus[1].toDouble();
            m_cameraData.look[2] = focus[2].toDouble();
...
bool ScenefileReader::parseGroupData(const QJsonObject &object, SceneNode *node) {
    ...
    if (object.contains("translate")) {
        ...
        translation->translate[0] = translateArray[0].toDouble();
        translation->translate[1] = translateArray[1].toDouble();
        translation->translate[2] = translateArray[2].toDouble();
    ...
    if (object.contains("rotate")) {
        ...
        rotation->rotate[0] = rotateArray[0].toDouble();
        rotation->rotate[1] = rotateArray[1].toDouble();
        rotation->rotate[2] = rotateArray[2].toDouble();
    ...
    if (object.contains("scale")) {
        ...
        scale->scale[0] = scaleArray[0].toDouble();
        scale->scale[1] = scaleArray[1].toDouble();
        scale->scale[2] = scaleArray[2].toDouble();
    ...
    if (object.contains("matrix")) {
        ...
        float *matrixPtr = (matrixTransformation->matrix).data(); //equivalent to glm's value_ptr (returns data ptr)
        int rowIndex = 0;
